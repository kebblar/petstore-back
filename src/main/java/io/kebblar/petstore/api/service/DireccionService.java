...
public interface DireccionService {
     ...
     */
    Direccion getById(Direccion direccion) throws ServiceException;
     ...
     */
    List<Direccion> getAll() throws ServiceException;
     ...
     */
    int insert(Direccion direccion) throws ServiceException;
     ...
     * @throws ServiceException es disparada por una regla de negocio
     */
    int update(Direccion direccion) throws ServiceException;
     ...
     */
    int save(Direccion direccion) throws ServiceException;
     ...
     * @throws ServiceException es disparada por una regla de negocio
     */
    int delete(Direccion direccion) throws ServiceException;
     ...
     */
    List<DireccionConNombre> getDireccionesNombre(int idUser) throws ServiceException;
     ...
     * @throws ServiceException En caso que ocurra un error en el sistema o en el proceso de inserción.
     */
    int agregaDireccion(NuevaDireccion nuevaDireccion) throws ServiceException;
