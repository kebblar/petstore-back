...
public interface TipoDireccionService {
     ...
     */
    TipoDireccion getById(int id) throws ServiceException;
     ...
     */
    List<TipoDireccion> getAll() throws ServiceException;
     ...
     */
    int insert(TipoDireccion tipoDireccion) throws ServiceException;
     ...
     * @throws ServiceException es disparada por una regla de negocio
     */
    int update(TipoDireccion tipoDireccion) throws ServiceException;
     ...
     */
    int save(TipoDireccion tipoDireccion) throws ServiceException;
     ...
     * @throws ServiceException es disparada por una regla de negocio
     */
    int delete(TipoDireccion tipoDireccion) throws ServiceException;
