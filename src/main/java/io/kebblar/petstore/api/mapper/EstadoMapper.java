...
public interface EstadoMapper {
    ...
    Estado getById(int id) throws PersistenceException;
    ...
    List<Estado> getAll() throws PersistenceException;
    ...
    int insert(Estado estado) throws PersistenceException;
    ...
    int update(Estado estado) throws PersistenceException;
     ...
     * @throws java.sql.PersistenceException Si ocurre un error en la consulta o en el sistema.
     */
    @Select("SELECT " + CAMPOS_EDO + " FROM estado WHERE id_pais=#{id}" )
    List<Estado> getByPais(int id) throws PersistenceException;
    ...
    List<Estado> getAllNombrePais() throws PersistenceException;
    ...
    List<Estado> getByNombre(String nombre) throws PersistenceException;
    ...
    List<Estado> getByNombreAndIdPais(String nombre, int idPais) throws PersistenceException;
