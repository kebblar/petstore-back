...
public interface ConsultaMapper {
    ...
    /**
     * Obtiene una lista de objetos de tipo 'ConsultaResponse'.
     *
     * @return Lista de objetos de tipo ConsultaResponse
     * @throws java.sql.SQLException Se dispara en caso de que ocurra un error en esta operación desde la base de datos.
     */
    @Results(id="ConsultaFullMap", value = {
            @Result(property = "idUsuario",column = "id_usuario"),
            @Result(property = "idCombo",  column = "id_combo"),
            @Result(property = "idOpcion", column = "id_opcion")
    })
    @Select("SELECT id_usuario, id_combo, id_opcion FROM consulta ")
    List<Consulta> getAll() throws SQLException;
    ...
    int insert(Consulta consulta) throws SQLException;
