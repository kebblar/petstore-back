...
public final class Campos {
    ...
    public static final String CAMPOS_ORDEN = " id, id_usuario, id_direccion_envio, id_paqueteria, id_metodo_pago, id_moneda, id_anuncio, cve_orden_compra, importe_total, fecha_hora_comprar, estado_envio, recibo ";
    ...
    public static final String CAMPOS_REG = " id, nick, correo, clave_hash, telefono, fecha_nacimiento, random_string, instante_registro ";
