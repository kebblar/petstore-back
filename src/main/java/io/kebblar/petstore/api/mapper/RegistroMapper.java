...
public interface RegistroMapper {
     ...
     * @throws java.sql.PersistenceException En caso de que haya un problema con la consulta
     */
    ...
    Preregistro getByMail(String correo) throws PersistenceException;
    ...
    Preregistro getByRandomString(String randomString) throws PersistenceException;
    ...
    Integer asociateRol(int idUsuario, int idRol) throws PersistenceException;
    ...
    Integer insertUsuarioDetalles(UsuarioDetalle usuarioDetalle) throws PersistenceException;
    ...
    Integer updateUsuarioDetalles(UsuarioDetalle usuarioDetalle) throws PersistenceException;
    ...
    Integer insert(Preregistro preregistro) throws PersistenceException;
    ...
    Integer update(Preregistro registro) throws PersistenceException;
    ...
    Integer deleteByRandomString(String randomString) throws PersistenceException;
