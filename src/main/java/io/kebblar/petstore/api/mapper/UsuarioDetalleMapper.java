...
public interface UsuarioDetalleMapper {
    ...
    UsuarioDetalle getById(int idUsuario) throws PersistenceException;
    ...
    List<UsuarioDetalle> getAll() throws PersistenceException;
    ...
    Integer insert(UsuarioDetalle usuarioDetalle) throws PersistenceException;
    ...
    Integer update(UsuarioDetalle usuarioDetalle) throws PersistenceException;
     ...
     * @throws java.sql.PersistenceException dispara en caso de que se dispare un error en esta operación desde la base de datos.
     */
    @Delete("DELETE FROM usuario_detalle WHERE id_usuario = #{id} ")
    Integer delete(int id) throws PersistenceException;

    @Insert("update usuario_detalle set foto_perfil = #{nuevoNombre} where id_usuario=#{idUser}")
    int subeFotoPerfil(int idUser, String nuevoNombre) throws PersistenceException;

    @Select("SELECT foto_perfil FROM usuario_detalle WHERE id_usuario = #{idUser}")
    String getProfilePic(int idUser) throws PersistenceException;
    
    
    
    @Insert("update usuario_detalle set descripcion = #{descripcion}, descripcion_plane_text = #{descripcionPlaneText} where id_usuario=#{idUser}")
    int updateDescripcion(int idUser, String descripcion, String descripcionPlaneText) throws PersistenceException;

    @Select("SELECT descripcion FROM usuario_detalle WHERE id_usuario = #{idUser}")
    String getDescripcion(int idUser) throws PersistenceException;
